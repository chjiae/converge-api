...
public class InternalStatusHandler {
    ...
    public void ready(RoutingContext context) {
        ...
        JsonObject data = new JsonObject()
                ...
                .put("tenantIndexCount", status.tenantIndexCount())
                ...
                .put("loadedClientKeyCount", status.loadedClientKeyCount())
                .put("loadedAccessGroupCount", status.loadedAccessGroupCount())
                .put("loadedGrantCount", status.loadedGrantCount())
                .put("loadedRoutePlanCount", status.loadedRoutePlanCount())
                .put("loadedRuntimePolicyCount", status.loadedRuntimePolicyCount())
                .put("invalidRouteTenantCount", status.invalidRouteTenantCount())
                .put("snapshotRefreshTotalCount", status.snapshotRefreshTotalCount())
                .put("snapshotRefreshSkippedCount", status.snapshotRefreshSkippedCount())
                .put("snapshotRefreshFailedCount", status.snapshotRefreshFailedCount())
                .put("tenantRefreshInFlightCount", status.tenantRefreshInFlightCount())
                .put("tenantRefreshPendingCount", status.tenantRefreshPendingCount())
                .put("lastTenantRefreshEpochMillis", status.lastTenantRefreshEpochMillis())
                .put("lastFullReconcileEpochMillis", status.lastFullReconcileEpochMillis())
                .put("lastRefreshDurationMs", status.lastRefreshDurationMs())
                .put("maxRefreshDurationMs", status.maxRefreshDurationMs())
                .put("estimatedSnapshotPayloadBytes", status.estimatedSnapshotPayloadBytes())
